...
from systems.SVHN.utils.transforms.transforms import SVHNCHANNELSTATS
...
class SVHNInputsSnapshot(RGBInputsSnapshot):
    ...
    def __init__(self,
        ...
        super(SVHNInputsSnapshot, self).__init__(platform=platform, writerstub=writerstub,
                                                 n_epochs=n_epochs, n_batches=n_batches,
                                                 start=start, period=period,
                                                 name=name, module=module, n_inputs=n_inputs, preprocessing_type=preprocessing_type, preprocessing_stats=SVHNCHANNELSTATS['normalize'], writer_kwargs=writer_kwargs)
