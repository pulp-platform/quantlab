...
def load_data_set(partition: str,
    ...
    if partition in {'train', 'valid'}:
        ...
        if n_folds > 1:  # this is a cross-validation experiment
            ...
            dataset = torchvision.datasets.MNIST(root=path_data, train=True, download=True, transform=transform)
            ...
            dataset = torchvision.datasets.MNIST(root=path_data, train=True if partition == 'train' else False, download=True, transform=transform)
