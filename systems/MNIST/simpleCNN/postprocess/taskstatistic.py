...
from systems.MNIST.utils.statistics import MNISTStatistic
...
class simpleCNNStatistic(MNISTStatistic):

    def __init__(self,
                 platform: PlatformManager, writerstub: WriterStub,
                 n_epochs: int, n_batches: int,
                 train: bool):
        super(simpleCNNStatistic, self).__init__(platform=platform, writerstub=writerstub,
