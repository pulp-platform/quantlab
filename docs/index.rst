...
QuantLab provides device-specific graph optimisation and code generation functionalities for some devices too: in this case, you might want to have a look at the :ref:`list of supported backends <supported-backends>`.
