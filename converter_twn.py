...
H2Htemplate_1 = morpher.get_template(Q, 'avgpool.tunnel.0', 'classifier.2.tunnel.0', include_interface=True)
rho_H2H1 = ScopeRule(H2Htemplate_1, set(['avgpool.tunnel.0', 'classifier.2.tunnel.0']))

H2Htemplate_2 = morpher.get_template(Q, 'classifier.5.tunnel.0', '__output_tunnel', include_interface=True)
rho_H2H2 = ScopeRule(H2Htemplate_2, set(['classifier.5.tunnel.0', '__output_tunnel']))
